    ...
    <main className="min-h-screen bg-slate-50">
      ...
      <section className="mx-auto max-w-7xl px-6 py-10">
        ...
        <div className="grid gap-5 md:grid-cols-3">
          <div className="rounded-2xl bg-white p-6 shadow-sm"><Wifi className="text-emerald-600" /><h3 className="mt-4 font-bold">Estaciones</h3><p className="mt-2 text-sm text-slate-500">Configurar ECOIA-001, ECOIA-002 y futuras estaciones.</p></div>
